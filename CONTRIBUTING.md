...
`evals/fixtures/mini-app/` (Node) and `evals/fixtures/mini-py/` (Python) are **intentionally defective** — see [evals/fixtures/README.md](evals/fixtures/README.md) for the list of planted defects and which skill should find each. Do not fix them.
