...
- Use the specialist skills when the user's primary goal is narrower: `test-gap-audit` for coverage gaps, `docs-sync-audit` for documentation drift, `docs-structure` for documentation layout, and `repo-health-audit` for structure/reuse.
