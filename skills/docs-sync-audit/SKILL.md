...
No code changed. I compared <source/code/change scope> against <docs checked>. <n> docs inventoried, <n> deep-inspected, <n> partially inspected, <n> surveyed only. <verification summary>. No P0s found / P0s found: <count>; <n> P1, <n> P2, <n> P3.
