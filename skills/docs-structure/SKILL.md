...
| R7 | no `file.ext:123` citations into source files, in prose or in a code span - backticks do not stop a line number rotting; a token containing `://` is a URL; the file has to exist | on; warn in record folders | P2 |
