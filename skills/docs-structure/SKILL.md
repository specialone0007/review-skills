...
| --- | --- | --- | --- |
| agent | `AGENTS.md` at the root (+ `CLAUDE.md` = `@AGENTS.md` when `.claude/` exists) | always | packages, tree, ci, tests - the skeleton is built by the checker from the manifests' own script names, forty lines at most |
